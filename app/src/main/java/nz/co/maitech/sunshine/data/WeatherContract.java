...
public class WeatherContract {
    ...
    public static final String CONTENT_AUTHORITY = "nz.co.maitech.sunshine.app";
    ...
    public static final class LocationEntry implements BaseColumns {
        ...
        // Location string for sending queries to the Open Weather API
        public static final String COLUMN_LOCATION_SETTING = "location_setting";

        // Human readable, and presentable name of the location.
        public static final String COLUMN_CITY_NAME = "city_name";

        // Coordinates for viewing the location on a map.
        ...
        public static Uri buildLoactionUri(long id) {
